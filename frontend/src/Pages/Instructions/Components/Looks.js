                    ...
                    <div className={styles.bg}>
                        ...
                        <div className={styles.sub}>
                            <h2>
                                ...
                                * The quiz will consist of 10 MCQ questions, 8 easy, 6 medium, and 6 hard.<br />
                                * There will be only one correct option per question<br />
                                * -1 marks will be deducted for the wrong answer<br />
                                * The quiz duration will be 15 mins<br />
                                * It is mandatory to switch on the camera and microphone during the quiz<br/>
                                * Remember You are being monitored, any suspicious activity will lead to disqualification<br/>
                            </h2>
                            <br/>
